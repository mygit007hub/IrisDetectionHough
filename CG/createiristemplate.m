...
%
% Usage:  [template, mask] = createiristemplate(eyeimage_filename)
%
% Arguments: eyeimage_filename   - the file name of the eye image
%
% Output: template		    - the binary iris biometric template
...
if stat == 1
    ...
    % circleiris= rowposition, colm position, radius
end
...
w = cd;
cd(DIAGPATH);
imwrite(template,[eyeimage_filename,'-biometric-templete.jpg'],'jpg');
cd(w);